    ...
    if (editingBlock.type === BlockType.MEDIA && files.length > 1) {
      Promise.all(
        ...
        .then((results) => {
          ...
          const nextItems = [
            ...currentItems,
            ...results.map((result) => createMediaGalleryItem(result)),
          ];
          updateBlock(
            syncMediaGalleryBlock(
                    ...
                    <fieldset>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          onClick={() =>
                            updateBlock({ ...editingBlock, textColor: 'text-gray-700' })
                          }
                          className={`flex-1 py-2 px-3 rounded-lg border text-xs font-semibold transition-all flex items-center justify-center gap-2 ${
                          ...
                          <fieldset>
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                ...
                                onClick={() =>
                                  updateBlock({ ...editingBlock, textColor: undefined })
                                }
                                className={`flex-1 py-2 px-3 rounded-lg border text-xs font-semibold transition-all flex items-center justify-center gap-2 ${
                            ...
                            >
                              ...
                              <div className="flex flex-wrap gap-2 mt-3">
                                <div className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-gray-100 text-gray-700 text-xs font-medium">
                                  <Images size={12} />
                                  {
                                    normalizeMediaGalleryState(editingBlock).filter(
                                      (item) => item.enabled
                                    ).length
                                  }{' '}
                                  active
